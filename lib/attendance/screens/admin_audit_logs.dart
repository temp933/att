...
class _DrawCampusOSMState extends State<DrawCampusOSM> {
  ...
  void _finishDrawing() {
    ...
    print("PERIMETER: ${totalDistance.toStringAsFixed(2)} m");
    print("AREA: ${_calculatePolygonArea(points).toStringAsFixed(2)} sq.m");
  }
                  ...
                  markers: List.generate(points.length, (index) {
                    ...
                    return Marker(
                      ...
                      child: GestureDetector(
                        onPanUpdate: (details) {
                          final screenPoint = _mapController.camera
                              .latLngToScreenPoint(p);

                          final newPoint = CustomPoint<double>(
