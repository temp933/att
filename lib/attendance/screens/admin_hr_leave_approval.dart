...
//       'All'; // 'All' | 'Approved' | 'Rejected' | 'Pending' | 'Cancelled'
//   bool _historySortAsc = false; // false = newest first
...
//           l.empId.toString().contains(q); // ← ADD THIS
...
//     // 4 — Pending Manager (TL recommended, waiting manager)
